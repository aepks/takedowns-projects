...
class Session:
    ...
    def readPenalties(self):
        ...
        for penalty in penalties:
            ...
            for user in assignedUsers:
                ...
                <br>
                <p>If you promptly fix these issues, and send proof to me (Justin), I'll issue a credit for half of this penalty.</p>
    ...
    def updateTakedowns(self):
        ...
        curDate = datetime.datetime(day=28, month=2, year=2020)
